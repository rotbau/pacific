...
SV_IP='10.0.100.50' #VIP for the Supervisor Cluster
VC_IP='10.0.100.13' #URL for the vCenter
VC_ADMIN_USER='administrator@vsphere.local' #User for the Supervisor Cluster
VC_ADMIN_PASSWORD='D1llh0le!' #Password for the Supervisor Cluster user
